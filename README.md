...
- Costs remained flat (€0.1M–€0.5M); revenue peaks at 78% occupancy but drops at 81%, suggesting discounting or lower-yield mix. The break-even point (BEP) was ~76%, with higher occupancy driving extra costs.
...
- Unsold rooms are the main source (87.61%) of revenue loss. OOO accounts for 10.84%, while no-shows (1.03%) and cancellations (0.51%) are minimal.
